          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative h-[500px] w-full rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/images/services/cybersec2.png"
              ...
              <div className="absolute -top-4 -right-4 bg-white rounded-xl shadow-lg p-4 border border-border">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">99.9% Threat Detection</span>
                </div>
              </div>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/20">
              <CardHeader>
                <div className="flex items-center mb-4">
                  ...
                  <CardTitle className="text-xl">Security Assessment & Auditing</CardTitle>
                </div>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/20">
              <CardHeader>
                <div className="flex items-center mb-4">
                  ...
                  <CardTitle className="text-xl">24/7 Security Monitoring</CardTitle>
                </div>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/20">
              <CardHeader>
                <div className="flex items-center mb-4">
                  ...
                  <CardTitle className="text-xl">Incident Response & Recovery</CardTitle>
                </div>
